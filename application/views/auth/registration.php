        ...
        <div class="col-lg">
          <div class="p-5">
            <div class="text-center">
              <img src="<?= base_url('assets/img/icon/BUNGA SEPASANG.png') ?>" class="mb-4" height="155" width="195">
              <h1 class="h4 text-gray-900 mb-4">Registrasi Akun Anda</h1>
            </div>
            <form class="user" method="post" action="<?= base_url('auth/registration'); ?>">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-6">
                  <input type="password" class="form-control form-control-user" id="pass2" name="pass2" placeholder="Ulangi Password">
                </div>
              </div>
