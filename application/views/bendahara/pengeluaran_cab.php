                                ...
                                <tr>
                                    ...
                                    <td colspan="2">
                                        <?php foreach ($pengeluaran as $p) : ?>
                                            <h5><b><?= "Rp " . number_format($p['jml_pengeluaran'], 0, ".", "."); ?></b></h5>
                                        <?php endforeach; ?>
                                    </td>
                                </tr>
                            </tfoot>
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="<?= base_url('bendahara/pengeluaranCabang'); ?>" method="post">
    ...
    <div class="modal fade" id="editModal<?= $trx['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="<?= base_url('bendahara/updatePengeluaranCabang'); ?>" method="post">
    ...
    <div class="modal fade" id="deleteModal<?= $trx['id']; ?>" tabindex="-1" aria-labelledby="deleteModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <a class="btn btn-danger" href="<?= base_url('bendahara/deletePengeluaranCabang/') . $trx['id'] ?>">Hapus</a>
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Tutup</button>
                </div>
            </div>
        </div>
